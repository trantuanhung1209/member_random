...
export default function AeroShards({
 ...
 const scheduleRaf = () => {
 if (disposed || runtimeFailed || animationFrameId || !visible) return;
 animationFrameId = requestAnimationFrame(scheduleFrame);
 };

 const scheduleSleep = targetTimestamp => {
 if (disposed || runtimeFailed || timeoutId || animationFrameId || !visible) return;
 ...
 animationFrameId = 0;
 if (disposed || runtimeFailed || !visible) return;
